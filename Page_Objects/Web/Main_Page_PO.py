class Main_Page:
    ...
    def new_transaction_btn(self):
        return self.driver.find_element_by_xpath(
            "//a[@data-test='nav-top-new-transaction']"
        )

    def all_user_names(self):
        return self.driver.find_elements_by_xpath(
            "//ul[@data-test='users-list']/li/div[2]/span"
        )
    ...
    def make_transfer_btn(self):
        return self.driver.find_element_by_xpath(
            "//button[@data-test='transaction-create-submit-payment']"
        )
    ...
    def verify_transfer(self):
        return self.driver.find_element_by_xpath(
            "//div[@class='MuiGrid-root MuiGrid-item'][1]/h2"
        )
